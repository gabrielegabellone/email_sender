...
class EmailsTestCase(TestCase):
    ...
    def test_email_all_users_ok(self):
    ...
    def test_email_all_users_error_sending_email(self, mock_send_mail):
    ...
    def test_email_all_users_missing_subject(self):
    ...
    def test_email_all_users_missing_message(self):
    ...
    def test_email_specific_users_ok(self):
        """Tests the correct response of the endpoint when sending emails is successful and that the email is sent to
        the correct users."""
    ...
    def test_email_specific_users_missing_recipients(self):
    ...
    def test_email_specific_users_emails_partially_sent(self):
        ...
        self.assertIn(b'{"msg":"Emails partially sent, users not found: [\'12\']"}', response.content)

    @patch('emails.views.send_mail')
    def test_email_specific_users_error_sending_email(self, mock_send_mail):
        """Tests the correct response of the endpoint when sending emails fails."""
        mock_send_mail.return_value = 0
